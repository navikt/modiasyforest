...
import static no.nav.sbl.dialogarena.modiasyforest.rest.domain.sykepengesoknad.oppsummering.Seksjon.BEKREFT_KORREKT_INFORMASJON;
import static no.nav.sbl.dialogarena.modiasyforest.rest.domain.sykepengesoknad.oppsummering.Seksjon.SOKNAD;
import static no.nav.sbl.dialogarena.modiasyforest.rest.domain.sykepengesoknad.oppsummering.Seksjon.VAER_KLAR_OVER_AT;
