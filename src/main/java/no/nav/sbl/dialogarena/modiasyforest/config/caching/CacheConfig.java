...
public class CacheConfig {
    ...
    public CacheManager ehCacheManager() {
        ...
        config.addCache(setupCache("diskresjonskode"));
        config.addCache(setupCache("sykmelding"));
        config.addCache(setupCache("sykepengesoknad"));
        ...
        config.addCache(setupCache("tidslinjer"));
