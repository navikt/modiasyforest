...
import no.nav.sbl.dialogarena.modiasyforest.controller.domain.*;
import no.nav.sbl.dialogarena.modiasyforest.controller.domain.sykmelding.Sykmelding;
import no.nav.sbl.dialogarena.modiasyforest.controller.domain.tidslinje.Hendelse;
...
import static no.nav.sbl.dialogarena.modiasyforest.controller.domain.tidslinje.Hendelsestype.valueOf;
