...
@DirtiesContext
public class DiskresjonskodeRessursTest {
    ...
    public void henter_diskresjonskode() {
        ...
        DiskresjonskodeRessurs.DiskresjonskodeSvar diskresjonskodeSvar = diskresjonskodeRessurs.hentDiskresjonskode(ARBEIDSTAKER_FNR);
